 使用手机，偏振片，偏振光源搭建实验装置，通过手机摄像头采集图像，通过python实现图像处理，能大致观测到待测物体内部的张应力分布情况，图中越黑的部分应力大小越强
    ...
    class Button:
        def _init_(self, x, y, width, height, text, action=None):
            self.x, self.y = x, y
...
[背景图片](https://github.com/vencent-skywalker/file_for_download/blob/main/BG_pic.png?raw=true)

[苏科大校徽图片](https://github.com/vencent-skywalker/file_for_download/blob/main/skd1.png?raw=true)

[苏科大校徽图标](https://github.com/vencent-skywalker/file_for_download/blob/main/skd_icon.ico?raw=true)
